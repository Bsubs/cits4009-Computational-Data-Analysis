...
- Decision Tree: `video_views_rank` was by far the most impact feature, with it being use to make multiple splits in the same tree. However, unlike the logistic regression models, the decision tree models gave high priority to `video.views`.   
