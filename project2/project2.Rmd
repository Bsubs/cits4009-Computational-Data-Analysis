...
The following functions will be used in the evaluation of the decision tree and logistic regression model
...
The following function returns a logistic regression model using GLM given a set of data. We use 10-fold cross validation, the data is divided into 10 parts, where 9 parts are used for training and 1 part is used for validation. This process is repeated 10 times, each time using a different part for validation.
